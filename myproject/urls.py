...
from app.views import LotteryViewSet, LotteryByPhoneView, LotteryCampaignListView, LotteryNumberAllView
...
urlpatterns = [
    ...
    path("lotteries/numbers/all/", LotteryNumberAllView.as_view(), name="lottery-numbers-all"),
